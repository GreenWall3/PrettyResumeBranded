        ...
        >
          ...
          <div className="text-center mb-12 pt-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
              Learn how we use cookies to enhance your experience on Pretty Resume.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-purple-100 mb-16">
            <div className="prose prose-indigo max-w-none">
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">1. What Are Cookies?</h2>
              ...
              <p className="text-gray-700 mb-6">
                Pretty Resume uses cookies to enhance your experience, gather general visitor information, and track visits to our website. These cookies help us understand how you use our site so we can improve its functionality and performance.
              </p>
              
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">2. Types of Cookies We Use</h2>
              
              <h3 className="text-xl font-medium mb-3 text-indigo-600">2.1 Essential Cookies</h3>
              ...
              <h3 className="text-xl font-medium mb-3 text-indigo-600">2.2 Analytics Cookies</h3>
              <p className="text-gray-700 mb-4">
                We use analytics cookies to collect information about how visitors use our website. These cookies help us understand, for example, which pages visitors go to most often. We use this information to improve our website and your browsing experience.
              </p>
              
              <h3 className="text-xl font-medium mb-3 text-indigo-600">2.3 Functionality Cookies</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-medium mb-3 text-indigo-600">2.4 Marketing Cookies</h3>
              <p className="text-gray-700 mb-6">
              ...
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">3. How to Manage Cookies</h2>
              <p className="text-gray-700 mb-4">
              ...
              <p className="text-gray-700 mb-4">
                To find out more about cookies, including how to see what cookies have been set and how to manage and delete them, visit <a href="https://www.allaboutcookies.org" className="text-indigo-600 hover:text-indigo-800 transition-colors">www.allaboutcookies.org</a>.
              </p>
              <p className="text-gray-700 mb-6">
                Below are links to guides on how to manage cookies in various browsers:
              </p>
              <ul className="list-disc pl-6 mb-6 text-gray-700">
                <li className="mb-2"><a href="https://support.google.com/chrome/answer/95647" className="text-indigo-600 hover:text-indigo-800 transition-colors">Google Chrome</a></li>
                <li className="mb-2"><a href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences" className="text-indigo-600 hover:text-indigo-800 transition-colors">Mozilla Firefox</a></li>
                <li className="mb-2"><a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" className="text-indigo-600 hover:text-indigo-800 transition-colors">Safari</a></li>
                <li className="mb-2"><a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" className="text-indigo-600 hover:text-indigo-800 transition-colors">Microsoft Edge</a></li>
              </ul>
              
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">4. Third-Party Cookies</h2>
              <p className="text-gray-700 mb-6">
                In addition to our own cookies, we may also use various third-party cookies to report usage statistics of the website, deliver advertisements, and so on. These cookies may track your browsing habits across multiple websites.
              </p>
              
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">5. Updates to This Policy</h2>
              <p className="text-gray-700 mb-6">
                We may update this Cookie Policy from time to time in order to reflect changes to the cookies we use or for operational, legal, or regulatory reasons. Please therefore re-visit this Cookie Policy regularly to stay informed about our use of cookies and related technologies.
              </p>
              <p className="text-gray-700 mb-6">
                The date at the bottom of this page indicates when it was last updated.
              </p>
              
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">6. Contact Us</h2>
              <p className="text-gray-700 mb-6">
                If you have any questions about our use of cookies or this Cookie Policy, please <a href="/contact" className="text-indigo-600 hover:text-indigo-800 transition-colors">contact us</a>.
              </p>
