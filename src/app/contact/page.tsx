...
import { MailIcon, PhoneIcon, ClockIcon, MapPinIcon, LayoutDashboard } from "lucide-react";
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
            ...
            <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-purple-100">
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">Our Information</h2>
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Mon-Sun 8 AM - 5PM EST</p>
                  </div>
                </div>
              </div>
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-5 bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-purple-100">
                <h2 className="text-2xl font-semibold mb-6 text-purple-700">Send a Message</h2>
          ...
          {/* FAQ Section with purple accents */}
          <div className="mt-8 bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-purple-100">
            <h2 className="text-3xl font-bold mb-8 text-center bg-gradient-to-r from-indigo-600 via-purple-600 to-violet-600 text-transparent bg-clip-text">
              Frequently Asked Questions
            </h2>
            
            <div className="space-y-8">
              <div className="p-6 rounded-xl hover:bg-purple-50 transition-colors">
              ...
              <div className="p-6 rounded-xl hover:bg-purple-50 transition-colors">
                ...
                <p className="text-gray-600">
                  Currently, we provide support via email only. This allows us to efficiently address your questions with the appropriate team members.
                </p>
              </div>
              
              <div className="p-6 rounded-xl hover:bg-purple-50 transition-colors">
                <h3 className="text-lg font-semibold mb-2 text-purple-700">
                  I'm having technical issues with my account. What should I do?
                </h3>
                <p className="text-gray-600">
                  Please provide detailed information about the issue in your message, including any error messages, and our technical team will assist you promptly.
                </p>
              </div>
            </div>
          </div>
