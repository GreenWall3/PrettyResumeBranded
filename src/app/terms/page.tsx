        ...
        >
          ...
          <div className="text-center mb-12 pt-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
              Please read these terms carefully before using Pretty Resume services.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-purple-100 mb-16">
            <div className="prose prose-indigo max-w-none">
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">1. Acceptance of Terms</h2>
              <p className="text-gray-700 mb-6">
                By accessing or using Pretty Resume services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this service.
              </p>
              
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">2. Use License</h2>
              <p className="text-gray-700 mb-4">
                Permission is granted to temporarily use Pretty Resume services for personal, non-commercial purposes only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
              <ul className="list-disc pl-6 mb-6 text-gray-700">
                ...
                <li className="mb-2">Attempt to decompile or reverse engineer any software contained on Pretty Resume;</li>
              ...
              <p className="text-gray-700 mb-6">
                This license shall automatically terminate if you violate any of these restrictions and may be terminated by Pretty Resume at any time.
              </p>
              
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">3. User Accounts</h2>
              <p className="text-gray-700 mb-6">
              ...
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">4. User Content</h2>
              <p className="text-gray-700 mb-6">
                Our Service allows you to post, link, store, share and otherwise make available certain information, text, graphics, or other material. You retain any and all of your rights to any content you submit, post or display on or through the Service and you are responsible for protecting those rights.
              </p>
              <p className="text-gray-700 mb-6">
                You represent and warrant that your content does not violate or infringe upon the rights of any third party, including copyright, trademark, privacy, publicity, or other personal or proprietary rights, and does not contain libelous, defamatory, or otherwise unlawful material.
              </p>
              
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">5. Payment and Subscription</h2>
              <p className="text-gray-700 mb-6">
                Some parts of the Service are billed on a subscription basis. You will be billed in advance on a recurring and periodic basis, depending on the type of subscription plan you select. At the end of each period, your subscription will automatically renew under the exact same conditions unless you cancel it or Pretty Resume cancels it.
              </p>
              <p className="text-gray-700 mb-6">
                You may cancel your subscription renewal either through your online account management page or by contacting our customer support team. This must be done before the renewal date to avoid being charged for the upcoming period.
              </p>
              
              <h2 className="text-2xl font-semibold mb-6 text-purple-700">6. Disclaimer</h2>
              <p className="text-gray-700 mb-6">
                The materials on Pretty Resume's website are provided on an 'as is' basis. Pretty Resume makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
              </p>
              <p className="text-gray-700 mb-6">
                Further, Pretty Resume does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its website or otherwise relating to such materials or on any sites linked to this site.
              </p>
            </div>
          </div>
        </motion.div>
