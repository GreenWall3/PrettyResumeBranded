...
const LOCAL_STORAGE_KEY = 'Pretty_Resume-resume-scores';
const MAX_SCORES = 10;
        ...
        <Card className="relative overflow-hidden bg-gradient-to-br from-white/50 to-white/30 backdrop-blur-xl border-white/40">
          ...
          <div className="relative p-8 flex flex-col items-center gap-6 text-center">
            <div className="flex items-center gap-2">
              ...
              <Badge variant="outline" className="bg-orange-50 text-orange-600 border border-orange-200 h-5">
                <Crown className="w-3 h-3 mr-1" />
                PRO
              </Badge>
            </div>
            <p className="text-muted-foreground text-lg">
              Upgrade to Pro to analyze your resume and get personalized improvement suggestions.
            </p>
            <div className="flex flex-col items-center gap-3">
              <p className="text-sm text-muted-foreground">
                Pro members get detailed scoring on:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="flex items-center gap-2 text-sm text-emerald-700 bg-emerald-50 p-2 rounded-md">
                  <div className="h-2 w-2 rounded-full bg-emerald-500"></div>
                  <span>Completeness Analysis</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-cyan-700 bg-cyan-50 p-2 rounded-md">
                  <div className="h-2 w-2 rounded-full bg-cyan-500"></div>
                  <span>Impact Score</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-violet-700 bg-violet-50 p-2 rounded-md">
                  <div className="h-2 w-2 rounded-full bg-violet-500"></div>
                  <span>Role Match Evaluation</span>
                </div>
