...
import { User, Briefcase, FolderGit2, GraduationCap, Wrench, LayoutTemplate, Crown } from "lucide-react";
...
export function ResumeEditorTabs() {
  ...
  return (
    <>
      ...
      <div className="my-2">
      <TabsList className="h-full w-full relative bg-white/80 backdrop-blur-xl border border-white/40 rounded-lg overflow-hidden grid grid-cols-1 gap-0.5 p-0.5 shadow-lg">
          ...
          >
            ...
            <span className="relative text-sm whitespace-nowrap flex items-center gap-1.5">
              Resume Score
              {!isPro && (
