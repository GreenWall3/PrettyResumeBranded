...
const sections = [
  ...
  // Commented out to remove API Keys section
  ...
  return (
    <div className="flex gap-8 relative">
      ...
      <div className="flex-1 space-y-8">
        {/* Security Settings */}
        <Card id="security" className="border-border bg-white shadow-sm">
          <CardHeader>
        ...
        <Card id="subscription" className="border-border bg-white shadow-sm">
          <CardHeader>
        ...
        */}
        ...
        {/* Danger Zone */}
        <Card id="danger-zone" className="border-destructive/50 bg-white shadow-sm">
          <CardHeader>
