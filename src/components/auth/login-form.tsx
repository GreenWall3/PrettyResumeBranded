...
export function LoginForm() {
  ...
  // Clear URL error parameters if they exist to prevent showing the error dialog
  useEffect(() => {
    const errorParam = searchParams.get('error');
    if (errorParam && window.history.pushState) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      // Set a flag to indicate login is in progress to prevent error dialogs
      ...
      // If login was successful, redirect immediately to dashboard
      router.push('/dashboard');
      
    } catch (error: unknown) {
      // Don't show errors for NEXT_REDIRECT errors, as these are expected
